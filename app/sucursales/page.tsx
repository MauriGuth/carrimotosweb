...
export const metadata: Metadata = {
  title: 'Sucursales',
  description: 'Dónde estamos y con quién hablar en cada sucursal de CARRI Motos.',
};
    ...
    <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 sm:py-14">
      <header className="mb-10">
        ...
        <p className="mt-3 max-w-2xl text-sm text-mist-400 sm:text-base">
          Tenemos tres locales. Escribile directo al vendedor de la sucursal que te quede más cerca.
        </p>
      </header>
          ...
          <article key={s.slug} className="flex flex-col rounded-xl border border-ink-700 bg-ink-850 p-6">
            ...
            <dl className="mt-5 flex-1 space-y-4 text-sm">
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <dd className="text-mist-200">{s.direccion}</dd>
                  <dd className="text-mist-400">{s.ciudad}</dd>
                </div>
              </div>
              ...
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <dd className="text-mist-400">{s.telefonoVisible}</dd>
                </div>
              </div>
            </dl>
            ...
            <div className="mt-6 flex flex-col gap-2">
              <a
                ...
                className="titulo flex items-center justify-center gap-2 rounded-lg bg-[#25D366] px-5 py-3 text-xs tracking-widest text-white transition-opacity hover:opacity-90"
              >
                <IconoWhatsApp className="h-4 w-4" />
                Escribir a {s.vendedor}
              </a>
              {s.mapsUrl && (
                <a
                  href={s.mapsUrl}
