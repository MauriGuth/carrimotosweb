...
import { NEGOCIO, SUCURSALES } from '@/data/sucursales';
        ...
        <div className="lg:col-span-1">
          ...
          <div className="mt-5 flex gap-3">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Facebook de CARRI Motos"
              className="grid h-9 w-9 place-items-center rounded-full border border-ink-700 text-mist-400 transition-colors hover:border-carri hover:text-carri"
            >
              <svg viewBox="0 0 24 24" className="h-4 w-4" fill="currentColor" aria-hidden="true">
          ...
          <ul className="grid gap-4 sm:grid-cols-3">
            {SUCURSALES.map((s) => (
              <li key={s.slug}>
                ...
                <p className="mt-1 text-mist-400">{s.direccion}</p>
                <p className="text-mist-400">{s.ciudad}</p>
                <a
